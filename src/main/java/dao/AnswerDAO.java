...
public class AnswerDAO extends BaseHibernateDAO {
	...
	public Answer findById(java.lang.Integer id) {
		...
		try {
			Answer instance = (Answer) getSession().get("com.Answer", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Answer> findByExample(Answer instance) {
		...
		try {
			List<Answer> results = (List<Answer>) getSession().createCriteria("com.Answer").add(create(instance))
					.list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Answer instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Answer as model where model." + propertyName + "= ?";
	...
	public List<Answer> findByOrderId(Object orderId) {
		return findByProperty(ORDER_ID, orderId);
	}

	public List<Answer> findByText(Object text) {
